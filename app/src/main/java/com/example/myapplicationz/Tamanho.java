    ...
    void calcular(SQLiteDatabase banco) {
        ...
        if (!espaco1.getText().toString().isEmpty() && !comp.equals(Data.fluxo)) {
            ...
            try {
                ...
                Teclado.adicionarhist(banco, "Tamanho", espaco1.getText().toString() + spinner1.getSelectedItem().toString() + " = " + espaco2.getText().toString() + spinner2.getSelectedItem().toString(),
